...
<footer class="flex w-full items-center justify-center">
	<div class="my-3 flex h-8 justify-center">
		...
		<div class="grid h-7 w-24 flex-grow place-items-start items-center bg-base-100">
			<a href="https://github.com/wulfiss/weather" target="_blank" rel="noopener noreferrer">
				<svg
					class="h-5 object-contain dark:fill-base-content sm:h-5"
